...
const Color primeColor = Color.fromARGB(255, 0, 93, 74);
const Color primeLighterColor = Color.fromARGB(255, 5, 189, 152);
...
final darkTheme = ThemeData.from(
  ...
  textTheme: GoogleFonts.notoSansArabicTextTheme(Typography.whiteCupertino),
  primaryTextTheme:
      GoogleFonts.notoSansArabicTextTheme(Typography.whiteCupertino),
...
final lightTheme = ThemeData.from(
  ...
  textTheme: GoogleFonts.notoSansArabicTextTheme(Typography.blackCupertino),
  primaryTextTheme:
      GoogleFonts.notoSansArabicTextTheme(Typography.blackCupertino),
  dividerTheme: const DividerThemeData(
    endIndent: 10,
    indent: 10,
  ),
