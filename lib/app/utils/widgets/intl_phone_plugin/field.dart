...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    widget.controller?.addListener(() {
      if (widget.controller?.text.startsWith('+') ?? false) {
        widget.controller?.text = widget.controller?.text.replaceFirst(
                RegExp("^\\+${_selectedCountry.fullCountryCode}"), "") ??
            "";
      }
    });
  ...
  // getCountryCode(String num) {
  //   num.replaceFirst("+", "");
  //   for (var country in _countryList) {
  //     if (hasCountryCode(num, country)) {
  //       String extractedCountryCode = country.dialCode;
  //       String remainingNumber = num.substring(extractedCountryCode.length);
  //       _selectedCountry = country;
  //       print(extractedCountryCode);
  //       print(remainingNumber);
  //     }
  //   }
  // }

  bool hasCountryCode(String number, Country countryCode) {
    return number.startsWith(countryCode.dialCode);
  }
