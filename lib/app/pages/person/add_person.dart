...
//                               p0 != myAccount.id) {
//                             await context.navigateToEditPerson(p0);
//                           } else {
//                             await context.navigateToPerson(p0);
//                           }
//                         },
...
//                   !myAccount.custom!.appointStudent &&
//                   !myAccount.custom!.moderator
...
//                       IconButton(
//                         onPressed: () {
//                           CustomToast.showToast("حالة الطالب غير نشط");
//                         },
//                         icon: Icon(
//                           Icons.warning_amber,
...
//                                     var choosen =
//                                         await MySnackBar.showMyGroupOne(
...
//                                     setState(() {
//                                       _person.student!.groupIdName = choosen ??
//                                           _person.student!.groupIdName;
//                                     });
//                                   }
...
//                       IconButton(
//                           onPressed: () {
//                             CustomToast.showToast("حالة الأستاذ غير نشط");
//                           },
//                           icon: Icon(
//                             Icons.warning_amber,
//                             color: Theme.of(context).colorScheme.error,
...
//     }
//     if (context.mounted) {
//       CustomToast.showToast("لم يتم اختيار صورة");
//     }
