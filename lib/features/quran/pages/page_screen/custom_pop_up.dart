          ...
          onChanged: (val) {
            setState(() {
              if (hasForgetMistake) {
                ...
                list.add(Mistake(
                    idWord: widget.word.id, type: Mistake.forgetMistake));
              }
            });
          },
        ),
          ...
          onChanged: (val) {
            setState(() {
              if (hasTashkelMistake) {
                ...
                list.add(Mistake(
                    idWord: widget.word.id, type: Mistake.tashkelMistake));
              }
            });
          },
        ),
          ...
          onChanged: (val) {
            setState(() {
              if (hasTajweedMistake) {
                ...
                list.add(Mistake(
                    idWord: widget.word.id, type: Mistake.tajweedMistake));
              }
            });
          },
        ),
          ...
          onPressed: () {
            if (hasTashkelMistake &&
                list
                        ...
                        .pos ==
                    null) {
              CustomToast.showToast("الرجاء اختيار موقع الخطأ في الكلمة");
            } else {
